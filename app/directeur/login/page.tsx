    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0d1117] p-5">
      <div className="w-full max-w-[380px] bg-[#1c2128] border border-[#30363d] rounded-[20px] px-8 py-9">
        ...
        <button
          ...
          className={`w-full py-3 border border-[#30363d] rounded-xl text-white text-[15px] font-bold transition-all ${password ? 'bg-gradient-to-br from-sky-500 to-blue-600 cursor-pointer' : 'bg-[#161b22] cursor-default'}`}
        >
